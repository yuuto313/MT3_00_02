...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Matrix4x4 resultAdd = Add(m1, m2);//ok
		Matrix4x4 resultSubtract = Subtract(m1, m2);//ok
		Matrix4x4 resultMultiply = Multiply(m1, m2);//ok
		Matrix4x4 inverseM1 = Inverse(m1);
		Matrix4x4 inverseM2 = Inverse(m2);
		Matrix4x4 transposeM1 = Transpose(m1);//ok
		Matrix4x4 transposeM2 = Transpose(m2);//ok
		Matrix4x4 identity = MakeIdentity4x4();//ok
